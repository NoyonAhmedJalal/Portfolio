...
<head>
  ...
  <link rel="stylesheet" href="../front-ent/classic/style.css">  <!-- The above 6 meta tags *must* come first in the head; any other head content must come *after* these tags -->
...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                <a href="index.html" class="logo-icon"><span class="logo-text">Classic</span></a>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="../front-ent/classic/index.html" class="active"><i class="material-icons-two-tone">home</i>Classic</a>
                    </li>

                    <li class="active-page">
                        <a href="../front-ent/Unique Foods/index.html" class="active"><i class="material-icons-two-tone">home</i>Unique-Food</a>
                    </li>
                    ...
                    <li class="active-page">
                        <a href="index.html" class="active"><i class="material-icons-two-tone">settings</i>Setting</a>
                    </li>
                    <li class="active-page">
